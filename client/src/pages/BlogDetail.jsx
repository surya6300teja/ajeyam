        ...
        <div className="max-w-screen-xl mx-auto px-4 py-3 flex justify-between items-center relative z-10">
          ...
          <div className="flex items-center space-x-3">
            <a href="https://www.instagram.com/ajeyam_speaks?igsh=MXJueTV1bGF4eTVi" target="_blank" rel="noopener noreferrer"
              className="p-1.5 hover:bg-amber-50 rounded-full transition-colors" title="Follow on Instagram">
            ...
            <a href="https://www.facebook.com/AjeyamSpeaks" target="_blank" rel="noopener noreferrer"
              className="p-1.5 hover:bg-amber-50 rounded-full transition-colors" title="Follow on Facebook">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-amber-900" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="https://x.com/ajeyam_speaks" target="_blank" rel="noopener noreferrer"
              className="p-1.5 hover:bg-amber-50 rounded-full transition-colors" title="Follow on X (Twitter)">
